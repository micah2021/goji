-- Enhanced dictionary schema for Kushi wordlist import
...
CREATE INDEX IF NOT EXISTS idx_dictionary_goji_word_trgm ON public.dictionary_entries USING gin (goji_word gin_trgm_ops);
